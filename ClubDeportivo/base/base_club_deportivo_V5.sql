...
INSERT INTO persona (dni, nombre, apellido, aptoFisico) VALUES
(11111113, 'test-1', 'vencimiento-1', 1),
(22222224, 'test-2','vencimiento-2', 1),
(33333335, 'test-3','vencimiento-3', 1),
(44444446, 'test-4', 'vencimiento-4', 1),
(55555557, 'test-5', 'vencimiento-5', 1);

-- Insertar socios (con fechaAlta, carnetActivo, activo)
INSERT INTO socio (fechaAltaSocio, carnetActivo, valorCuota, dni, activo) VALUES
(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), 1, 8000.00, 11111113, 1),
(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), 1, 8000.00, 22222224, 1),
(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), 1, 8000.00, 33333335, 1),
(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), 1, 8000.00, 44444446, 1),
(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), 1, 8000.00, 55555557, 1);

-- Insertar cuotas con vencimiento hoy y pago hace un mes
INSERT INTO cuotasocio (idSocio, fechaPagoSocio, vencimientoPago, formaPago, numeroCuota, montoCuota, montoFinal, activo)
SELECT idSocio, DATE_SUB(CURDATE(), INTERVAL 1 MONTH), CURDATE(), 'Efectivo', 1, 8000.00, 8000.00, 1 FROM socio
WHERE dni IN (11111113, 22222224, 33333335, 44444446, 55555557);
